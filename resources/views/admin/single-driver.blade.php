...
@section('content')
                            ...
                            <div class="row ">
                                <div class="table-responsive">
                                  <table class="table">
                                    ...
                                    <td>
                                        @if ($data->driverPaymentInfo)
                                            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#paymentInfoModal" data-mode="edit"
                                                data-driver="{{ $data->id }}" data-payment='@json($data->driverPaymentInfo)'>
                                                Edit Payment Details
                                            </button>
                                        @else
                                            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#paymentInfoModal" data-mode="create"
                                                data-driver="{{ $data->id }}">
                                                Add Payment Details
                                            </button>
                                        @endif
    ...
    <div class="modal fade" id="paymentInfoModal" tabindex="-1" aria-labelledby="paymentInfoModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="paymentInfoModalLabel">Add Payment Info</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                @php  $paymentInfo= $data->driverPaymentInfo  @endphp
                <form  action="{{ $paymentInfo
                       ? url('admin/update_driver_payment_info/'.$paymentInfo->id)
                         : url('admin/add_driver_payment_info') }}"
                  method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="row g-3">
                            <input type="hidden" name="driver_id" value="{{ $data->id }}" id="">
                              <!-- Business Name -->
            <div class="col-md-6">
                ...
                <input type="text"
                       name="bussiness_name"
                       class="form-control"
                       value="{{ old('bussiness_name', $paymentInfo->bussiness_name ?? '') }}">
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="email"
                       name="email"
                       class="form-control"
                       value="{{ old('email', $paymentInfo->email ?? '') }}">
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text"
                       ...
                       class="form-control"
                       required
                       value="{{ old('address_line1', $paymentInfo->address_line1 ?? '') }}">
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text"
                       name="address_line2"
                       class="form-control"
                       value="{{ old('address_line2', $paymentInfo->address_line2 ?? '') }}">
            </div>
            ...
            <div class="col-md-4">
                ...
                <input type="text"
                       ...
                       class="form-control"
                       required
                       value="{{ old('city', $paymentInfo->city ?? '') }}">
            </div>
            ...
            <div class="col-md-4">
                ...
                <input type="text"
                       ...
                       class="form-control"
                       required
                       value="{{ old('state_code', $paymentInfo->state_code ?? '') }}">
            </div>
            ...
            <div class="col-md-4">
                ...
                <input type="text"
                       ...
                       class="form-control"
                       required
                       value="{{ old('postal_code', $paymentInfo->postal_code ?? '') }}">
            </div>
            ...
            <div class="col-md-4">
                ...
                <input type="text"
                       name="country_code"
                       class="form-control"
                       value="{{ old('country_code', $paymentInfo->country_code ?? 'US') }}">
            </div>
            ...
            <div class="col-md-4">
                ...
                <select name="language" class="form-select">
                    <option value="en" @selected(($paymentInfo->language ?? 'en') == 'en')>English</option>
                    <option value="es" @selected(($paymentInfo->language ?? '') == 'es')>Spanish</option>
                    <option value="fr" @selected(($paymentInfo->language ?? '') == 'fr')>French</option>
                </select>
            </div>
            ...
            <div class="col-md-4">
                ...
                <select name="currency" class="form-select">
                    <option value="USD" @selected(($paymentInfo->currency ?? 'USD') == 'USD')>USD</option>
                    <option value="EUR" @selected(($paymentInfo->currency ?? '') == 'EUR')>EUR</option>
                    <option value="GBP" @selected(($paymentInfo->currency ?? '') == 'GBP')>GBP</option>
                </select>
            </div>
                        </div>
                        <div class="modal-footer">
