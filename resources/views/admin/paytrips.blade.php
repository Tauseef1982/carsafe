        ...
        <div class="row size-column">
            <div class="col-xl-3 risk-col xl-100 box-col-12">
                <div class="card total-users">
                    ...
                    <form action="{{url('admin/add-payment')}}?is_admin=1" method="post" id="payment_form" onsubmit="disableButton()">
                        @csrf
                        <input hidden name="is_admin" value="1" />

                        <div class="card-body pt-0" id="trip-div">
                            <h5>Select Trip</h5>

                            <input class="form-control mb-4" name="accept_by"
                                   value="{{ auth()->check() && Auth::guard('admin')->user()->role == 'dispatcher' ? Auth::guard('admin')->user()->username : '' }}"
                                   id="accept_by" placeholder="Please write user name" />
                            @foreach ($trips as $trip)
                                <div class="card">
                                    <div class="media p-20">
                                        <div class="form-check radio radio-primary me-3">
                                            <input class="form-check-input trip-radio" id="radio{{$trip->id}}" type="radio" name="trip"
                                                   value="{{$trip->trip_id}}" data-trip-cost="{{$trip->trip_cost}}" title="" />
                        ...
                        <div class="card-body pt-0 hide" id="method-div">
                            ...
                            <div class="card" id="account-check">
                                <div class="media p-20">
                                    <div class="form-check radio radio-primary me-3">
                                        <input class="form-check-input" id="radio19" type="radio" name="payment_method" value="account"
                            ...
                            <div class="card" id="card-check">
                                <div class="media p-20">
                                    <div class="form-check radio radio-primary me-3">
                                        <input class="form-check-input" id="radio20" type="radio" name="payment_method" value="card"
                                               data-bs-original-title="" title="" />
                        ...
                        <!-- <div class="card-body pt-0 hide" id="complaint-div">
                        ...
                        <div class="card-body pt-0 hide" id="amount-div">
                            <h5>
                                Total Amount
                                <span class="badge badge-primary pull-right digits btn " id="show-method-div-btn-back">Go Back</span>
                            </h5>
                            <div class="card">
                                <div class="media p-20">
                                    <div class="input-group">
                                        <span class="input-group-text">$</span>
                                        <input class="form-control" type="tel" name="amount" autofocus value="" id="amount-field"
                                               placeholder="00.00" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="medi p-20 mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <span class="input-group-text">$</span>
                                        <input class="form-control price-span" type="tel" name="trip_price" value="" id="trip_price"
                                               disabled />

                                    </div>

                                    <label for="" style="cursor: pointer; text-decoration:underline " id="show-complaint-field">Have You Any Complaint</label>

                                    <br>
                                    {{-- <small>Stop, wait & any extra</small> --}}

                                    <span class="span-exto">Total Payable: <span class="price-span"></span>+<span id="extra-span"></span> =
                  ...
                  <div class="form-group mt-3"  style="display: none;" id="complaint-field">
                            ...
                            <div class="text-end mt-3">
                                <button class="btn btn-primary btn-block w-100 next-step-btn set-this-amount-to-amount" type="button">
                                    Next
                                </button>
                            </div>
                        </div>
                                ...
                                <div class="media p-20">
                                    <div class="">
                                        <input class="form-control mb-3" type="tel" name="account" value="" id="acc-field"
                                               ...
                                               <label for="" style="cursor: pointer; text-decoration:underline " id="show-extra-field">Add Extra Charges</label> <br>
...
<input class="form-control hide" type="tel" name="extra_charges" autofocus value="" id="extra_charges"
       placeholder="00.00 " />
...
<span class="input-group-text">$</span>
<input class="form-control me-2" type="tel" name="stop_amount" id="stop_amount" placeholder="00.00" />
</div>
<label for="stop_amount" class="me-2">Stop Location:</label>
<input type="text" class="form-control" name="stop_location" placeholder="Please Enter Stop Location Here">
<label for="wait_amount" class="me-2 ">Wait:</label>
<div class="input-group mb-3">

<span class="input-group-text">$</span>
<input class="form-control me-2" type="tel" name="wait_amount" id="wait_amount" placeholder="00.00" />
</div>
<label for="round_trip" class="me-2 ">Round Trip:</label>
<div class="input-group mb-3">

<span class="input-group-text">$</span>
<input class="form-control me-2" type="tel" name="round_trip" id="round_trip" placeholder="00.00" />
</div>
                        ...
                        <div class="card-body pt-0 hide" id="card-div">
                            ...
                            <div class="card">
                                ...
                                <div id="card-element-cardnox" style="margin-top: 50px">
                                    <div class="card-js" id="cardnox_inputs" data-capture-name="true" data-icon-colour="#158CBA"></div>
                                </div>
                    ...
                    <div class="px-3">
                        <button type="button" class="btn btn-outline-primary text-dark btn-block w-100" id="start-over">Start Over</button>
                    </div>
                            ...
                            if(response.success == true) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (response2) {
                                        ...
                                        window.location.href = "{{url('admin/success')}}/{{$drver_mainid}}"
                                        }else {
