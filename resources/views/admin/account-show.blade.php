...
@section('content')
            ...
            <div class=" risk-col xl-100 box-col-12">
                <div class="card total-users">
                    @if (session('status') && session('message'))
                        <div class="alert @if (session('status') == "error") alert-danger @else alert-success @endif  }}">
                            {{ session('message') }}
                        </div>
                    @endif
                    <div class="card-header card-no-border">
                        <h5>{{$account->f_name}} {{$account->lname}}</h5>
                        <a href="{{ url('admin/edit/account/') }}/{{$account->id  }}" target="_blank"
                        ...
                        <form action="{{ url('admin/update_account_restriction') }}" method="post">
                            ...
                            <div id="address-fields" style="{{ $account->address_restriction ? '' : 'display:none;' }}"
                                class="mt-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <form action="{{ url('admin/disable_account_payment') }}" method="post" class="mt-4">
                                    ...
                                    <input type="hidden" value="{{ $account->id }}" name="account_id">
                                    <label>
                                        <input type="checkbox" name="disable_account_payment" id="disable_account_paymnet"
                                            {{ $account->disable_account_payment ? 'checked' : '' }}>
                        ...
                        <div class="card-header-right">
                            ...
                            <button class="btn-sm btn-dark mt-3" onclick="download_invoice_link(' {{$account->id }} ')"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="changeStatusModalLabel">Change Status
                                                        </h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <form
                                                            action="{{ url('admin/account/status') }}/ {{  $account->id}} "
                                                            method="post">
                                                            @csrf
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="mb-3">
                                    <form action="{{url('admin/pay-to-refill')}}" method="POST">
                                        ...
                                        <input class="form-control btn-square" id="to_refill" type="number" name="to_refill"
                                            placeholder="Enter payment to Refill here" data-bs-original-title="" title="">
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                @else
                                    <div class="mb-3">
                                        ...
                                        <input type="text" readonly value="{{ $apikey->api_key }}" class="form-control mb-3"
                                            id="apiKeyInput">
                ...
                <div class="card total-users">
                    <div class="card-header card-no-border">
                        ...
                        <div class="card-header-right">
                            @if ($account->account_type == "prepaid")
                                <button class="btn btn-primary open-card-modal" data-bs-toggle="modal"
                                    data-id="{{ $account->account_id }}" data-bs-target="#addCreditCardModal">Add New
                                    Card</button>
                            @endif
            ...
            <div class="modal-content">
                ...
                <form action="{{route('admin.change-driver-fee')}}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" class="form-control" name="fee" placeholder="Please Enter new fee here" value="">
    ...
    <!-- card modal -->
    <div class="modal fade" id="addCreditCardModal" tabindex="-1" role="dialog" aria-labelledby="addCreditCardModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form method="post" action="{{ url('admin/add/credit-card') }}">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="hidden" class="form-control mb-3" name="account_id" id="account_id_card"
                                    required>
                            </div>
