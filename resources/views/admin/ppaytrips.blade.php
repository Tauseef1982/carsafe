                  ...
                  $<span id="total-span"></span> </span>
                        ...
                        <div class="card-body pt-0 hide" id="card-div">
                            ...
                            <div class="card">
                                ...
                                {{-- <input--}} {{-- type="text" --}} {{-- name="card_nmuber" --}} {{-- class="form-control" --}} {{--
                  placeholder="4444-4444-4444-4444" --}} {{-- />--}}
                                {{-- </div>--}}
                                {{-- <div class="row p-20">--}}
                                {{-- <div class="col-6">--}}
                                {{-- <label for="" --}} {{--><label for="" class="form-label" --}} {{-->Expiry Date</label--}}
                                {{-->--}}
                                {{-- <input--}} {{-- type="text" --}} {{-- name="card_expiry" --}} {{-- class="form-control" --}}
                                {{-- placeholder="MM/YY" --}} {{-- /></label>--}}
                                {{-- </div>--}}
                                {{-- <div class="col-6">--}}
                                {{-- <label for="" --}} {{--><label for="" class="form-label">CVC</label>--}}
...
@section('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            {{--            window.location.href = "{{url('admin/success')}}";--}}
            {{--        },--}}
