                                ...
                                <div class="  p-3 extracharges-field-div" data-id="2">
                                    <div class="mb-3">
                                        <div class="d-flex align-items-center mb-2">
                                            <button type="button"
                                                class="btn btn-primary btn-sm me-2 remove-stop-4 ">−</button>
                                            <span class="mx-2 fw-bold">$4 Stop</span>
                                            <button type="button"
                                                class="btn btn-secondary btn-sm ms-2 add-stop-4 ">+</button>
                                        </div>

                                        <div class="d-flex align-items-center mb-2">
                                            <button type="button"
                                                class="btn btn-primary btn-sm me-2 remove-stop-5 ">−</button>
                                            <span class="mx-2 fw-bold">$5 Stop</span>
                                            <button type="button"
                                                class="btn btn-secondary btn-sm ms-2 add-stop-5 ">+</button>
                                        </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <span class="input-group-text">$</span>
                                        <input class="form-control me-2 stop_amount" type="tel" name="stop_amount[]"
                                            readonly id="" placeholder="00.00" />
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <span class="input-group-text">$</span>
                                        <input class="form-control me-2 wait_amount" type="tel" name="wait_amount[]"
                                            readonly id="" placeholder="00.00" />
                                    </div>
                            ...
                            <div class="card">
                                <div class="media p-20">
                                    <div class="">
                                        ...
                                        <input type="text" class="form-control" id="account_pin_masked"
                                            autocomplete="new-password" inputmode="numeric" placeholder="Pin">
                                ...
                                <div class="  p-3 extracharges-field-div" data-id="1">
                                    <div class="mb-3">
                                        <div class="d-flex align-items-center mb-2">
                                            <button type="button"
                                                class="btn btn-primary btn-sm me-2 remove-stop-4 stops">−</button>
                                            <span class="mx-2 fw-bold">$4 Stop</span>
                                            <button type="button"
                                                class="btn btn-secondary btn-sm ms-2 add-stop-4 stops">+</button>
                                        </div>

                                        <div class="d-flex align-items-center mb-2">
                                            <button type="button"
                                                class="btn btn-primary btn-sm me-2 remove-stop-5 stops">−</button>
                                            <span class="mx-2 fw-bold">$5 Stop</span>
                                            <button type="button"
                                                class="btn btn-secondary btn-sm ms-2 add-stop-5 stops">+</button>
                                        </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <span class="input-group-text">$</span>
                                        <input class="form-control me-2 stop_amount" type="tel" readonly
                                            name="stop_amount[]" placeholder="00.00" />
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <span class="input-group-text">$</span>
                                        <input class="form-control me-2 wait_amount" type="tel" name="wait_amount[]"
                                            readonly id="wait_amount" placeholder="00.00" />
                                    </div>
