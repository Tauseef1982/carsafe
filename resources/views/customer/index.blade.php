...
>>>>>>> 9b67c86b9d7560cf14e43ef091900e5e71b6a6f4
                </div>
...
<<<<<<< HEAD
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button class="btn btn-transparent btn-xs text-primary" data-bs-toggle="modal"
                    ...
                    <div class="card bg-primary">
                        <div class="card-body">
                            ...
                            <div class="">
                                ...
                                <a href="{{ url('customer/book-ride') }}">
                                    <button class="btn btn-sm  text-primary bg-light f-14 fw-bold">
                                        Book a Ride
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-3">
                    <a href="{{ url('customer/trips') }}"
                       class="btn btn-transparent text-primary btn-outline-primary btn-sm f-14 f-w-700">View All Trips
                        <span><img src="{{ asset('assets/images/arrow-right-line.png') }}" alt=""></span></a>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row mt-3">
                <div class="col-md-9">
                    <span><h3 class="f-28 fw-bold">Upcomming Rides</h3></span>
                </div>
                <div class="col-md-3">
{{--                    <a href="{{ url('customer/trips') }}"--}}
{{--                       class="btn btn-transparent text-primary btn-outline-primary btn-sm f-14 f-w-700">View All Trips--}}
            ...
            <div class="row">
                ...
                <div class="col-sm-12 m-0 pt-0">
                    ...
                    <div class="">
                        ...
                        <div class="">
                            <div class="table-responsive ">
                                <table class="display" id="upcomming_trips">
                                    <thead class="table-header-light">
                                    <tr class="">
            ...
            <form action="{{url('customer/pay-to-refill')}}" method="post">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header bg-orange-g text-white">
                        ...
                        <button class="btn-close  btn-primary text-white" type="button" data-bs-dismiss="modal"
                        ...
                        <div class="card">
                            <div class="animate-widget">
                                ...
                                <div class="">
                                    ...
                                    <input class="card-number my-custom-class form-control" name="to_refill"
...
>>>>>>> 9b67c86b9d7560cf14e43ef091900e5e71b6a6f4
                    ...
                    <div class="modal-footer ">
                        <input type="submit" class="btn btn-dark mt-3 ms-auto bg-orange-g text-white"
                               value="Add Balance">
...
>>>>>>> 9b67c86b9d7560cf14e43ef091900e5e71b6a6f4
        ...
        $(document).ready(function () {
            ...
            $('#upcomming_trips').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{url('customer/upcomming-trips')}}",
                    type: 'GET',
                    data: function (d) {
                        d.account_id = "{{$account_id}}";
                    }
