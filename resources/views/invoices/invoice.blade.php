                                ...
                                <div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="media">
                                                <div class="media-left"><img class="media-object" style="width:175px;"
                                                        src="{{asset('assets/images/logo/carsafe-logo.webp')}}" alt="">
                                                </div>
                                        ...
                                        <div class="col-sm-3 text-md-end">
                                            ...
                                            @if ($account->account_type == 'prepaid')
                                                <img src="{{ asset('assets/images/paid.jpg') }}" style="width:100px; "
                                                    alt="">
                                            @else
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="text-md-end text-xs-center">
                                                ...
                                                <h5>Invoice #<span
                                                        class="">{{ $account_number }}{{now()->format('md')}}</span>
                                                </h5>
                                        ...
                                        <div class="col-md-8">
                                            <div>
                                                <p class="legal"><strong>Thank you for your business!</strong> 
                                                    ...
                                                    {{-- - @if($paidd < $cost) <div class="row no-print">
                                                        <div class="col-md-12">

                                                            <form method="post"
                                                                action="{{ url('admin/invoice/preview') }}">
                                                                @csrf
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <input type="hidden" class="form-control"
                                                                        name="type" id="type" value="credit" readonly>

                                                                </div>


                                                                <input class="btn btn-success mt-3"
                                                                    value="Update/Charge Card" type="submit">
