    ...
    public function PreRideStore(Request $request)
    {
        ...
        try {
            ...
            $bookingData = [
                ...
                $new->booking_data = json_encode($bookingData);
                $new->schedule_date_time = $date.' '.$time;
                $new->save();

                return back()->with([
                    'success' => 'Pre Booking added successful!',
