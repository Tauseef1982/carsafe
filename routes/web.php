...
Route::group(['middleware' => 'admin.auth'], function () {
        ...
        Route::post('/wait_charges_settings', [AdminController::class, 'wait_charges_settings']);
...
Route::group(['prefix' => 'customer','as' => 'customer.'], function () {
    ...
    Route::post('/pay-to-refill', [\App\Http\Controllers\UserPortalController::class, 'paymentToRefill']);
